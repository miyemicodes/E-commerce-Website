...
export default function Instawall() {
  return (
    <>
      <section className="px-16 py-8 bg-[#fffffc]">
        <h2 className="text-2xl font-semibold font-serif text-center pb-3">
          Instagram Wall
        </h2>
        <h3 className="text-sm font-normal text-center pb-4">
