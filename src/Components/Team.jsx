import teamImage1 from "../assets/man-with-glasses.jpg";
import teamImage2 from "../assets/lady-smiling.jpg";
	...
	return (
		<>
			<section className="py-6">
				...
				<div className="flex flex-col md:flex-row items-center justify-center gap-2 py-10 px-5 lg:px-20">
					<div className="hidden md:flex flex-col items-start justify-start gap-3 grow">
						<div className="h-[250px] lg:w-[150px] xl:w-full">
							<img
								src={teamImage1}
